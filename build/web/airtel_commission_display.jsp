<%@include file="header.jsp"%>
            ...
            <div class="box">
                ...
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>AIRTEL COMMISSIONS</strong>
                    </h2>
                    <hr>
                </div>
   ...
   <sql:query dataSource="${dbsource}" var="result"> SELECT * from airtel_commission; </sql:query> 
   ...
   <c:forEach var="row" items="${result.rows}"> 
       <tr> 
           ...
           <td><c:out value="${row.commission}"/></td> 
            <td><a href="airtel_commission_update.jsp?id=<c:out value="${row.id}"/>">Pay Commission</a></td>
       </tr>
    </c:forEach>
       </table
     </center>
